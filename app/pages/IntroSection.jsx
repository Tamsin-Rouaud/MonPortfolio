		...
		<section className='lg:py-16'>
			...
			<div className='grid grid-cols-1 sm:grid-cols-12'>
				...
				>
					...
					<div>
						<button
							aria-label='Envoyez moi un message'
							className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-900 via-primary-700  to-thirdly-500 font-bold text-white hover:bg-slate-200'
						>
							<Link href={href}>Envoyez-moi un message</Link>
						</button>
						<button
							aria-label='Téléchargez mon CV'
							className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-900 via-primary-700  to-thirdly-500 hover:bg-slate-800 text-white  mt-3'
						>
